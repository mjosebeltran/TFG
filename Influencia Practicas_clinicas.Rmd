---
title: "Influencia Practicas Clinicas"
...
# Descripcion variable "practicas clinicas"


```{r echo=TRUE, include=FALSE}
# A??adimos la variale SEXO
datosValencia_T1 <- cbind(datosValencia_T1, datosValencia$PrCLIN) %>%
  dplyr::rename(Practicas_clinicas = 'datosValencia$PrCLIN')

datosValencia_T1$Practicas_clinicas[datosValencia_T1$Practicas_clinicas == "0"] <- "No"
datosValencia_T1$Practicas_clinicas[datosValencia_T1$Practicas_clinicas == "1"] <- "Si"

datosValencia_T2 <- cbind(datosValencia_T2, datosValencia$PrCLIN) %>%
  dplyr::rename(Practicas_clinicas = 'datosValencia$PrCLIN')

datosValencia_T2$Practicas_clinicas[datosValencia_T2$Practicas_clinicas == "0"] <- "No"
datosValencia_T2$Practicas_clinicas[datosValencia_T2$Practicas_clinicas == "1"] <- "Si"


datosValencia_T3 <- cbind(datosValencia_T3, datosValencia$PrCLIN) %>%
  dplyr::rename(Practicas_clinicas = 'datosValencia$PrCLIN')

datosValencia_T3$Practicas_clinicas[datosValencia_T3$Practicas_clinicas == "0"] <- "No"
datosValencia_T3$Practicas_clinicas[datosValencia_T3$Practicas_clinicas == "1"] <- "Si"
```
...
datosUIB_T1 <- cbind(datosUIB_T1, datosUIB$PrClN) %>%
  dplyr::rename(Practicas_clinicas = 'datosUIB$PrClN')

datosUIB_T1$Practicas_clinicas[datosUIB_T1$Practicas_clinicas == "0"] <- "No"
datosUIB_T1$Practicas_clinicas[datosUIB_T1$Practicas_clinicas == "1"] <- "Si"

datosUIB_T2 <- cbind(datosUIB_T2, datosUIB$PrClN15) %>%
  dplyr::rename(Practicas_clinicas = 'datosUIB$PrClN15')

datosUIB_T2$Practicas_clinicas[datosUIB_T2$Practicas_clinicas == "0"] <- "No"
datosUIB_T2$Practicas_clinicas[datosUIB_T2$Practicas_clinicas == "1"] <- "Si"


datosUIB_T3 <- cbind(datosUIB_T3, datosUIB$PrClN87) %>%
  dplyr::rename(Practicas_clinicas = 'datosUIB$PrClN87')

datosUIB_T3$Practicas_clinicas[datosUIB_T3$Practicas_clinicas == "0"] <- "No"
datosUIB_T3$Practicas_clinicas[datosUIB_T3$Practicas_clinicas == "1"] <- "Si"
```
...
"No me pongo triste solo porque un amigo lo esta"
