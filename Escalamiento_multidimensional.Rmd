...
```{r echo=TRUE, message=FALSE, warning=FALSE, r,echo=FALSE}
...
datos_escmulti_T1 <- datos_T1 %>%
  ...
  dplyr::select(adopcion_perspectivas, comprension_emocional, estres_empatico, alegria_empatica, Sociodemo, Prof_sanitario, Universidad, Sexo)
...
datos_escmulti_T1 <- datos_escmulti_T1 %>%
  dplyr::mutate(Label = patrones) %>%
  dplyr::select(adopcion_perspectivas, comprension_emocional, estres_empatico, alegria_empatica, Sociodemo, Prof_sanitario, Label)
