...
datos <- datos_T1 %>%
  ...
  dplyr::select(adopcion_perspectivas, comprension_emocional, estres_empatico, alegria_empatica, score)
```


```{r}
round(quantile(datos$adopcion_perspectivas, 0.01, na.rm = TRUE), digits = 0)
round(quantile(datos$adopcion_perspectivas, 0.05, na.rm = TRUE), digits = 0)
round(quantile(datos$adopcion_perspectivas, 0.1, na.rm = TRUE), digits = 0)
round(quantile(datos$adopcion_perspectivas, 0.15, na.rm = TRUE), digits = 0)
round(quantile(datos$adopcion_perspectivas, 0.2, na.rm = TRUE), digits = 0)
round(quantile(datos$adopcion_perspectivas, 0.25, na.rm = TRUE), digits = 0)
round(quantile(datos$adopcion_perspectivas, 0.3, na.rm = TRUE), digits = 0)
 round(quantile(datos$adopcion_perspectivas, 0.35, na.rm = TRUE), digits = 0)
round(quantile(datos$adopcion_perspectivas, 0.40, na.rm = TRUE), digits = 0)
round(quantile(datos$adopcion_perspectivas, 0.45, na.rm = TRUE), digits = 0)
round(quantile(datos$adopcion_perspectivas, 0.50, na.rm = TRUE), digits = 0)
round(quantile(datos$adopcion_perspectivas, 0.55, na.rm = TRUE), digits = 0)
round(quantile(datos$adopcion_perspectivas, 0.60, na.rm = TRUE), digits = 0)
round(quantile(datos$adopcion_perspectivas, 0.65, na.rm = TRUE), digits = 0)
round(quantile(datos$adopcion_perspectivas, 0.70, na.rm = TRUE), digits = 0)
round(quantile(datos$adopcion_perspectivas, 0.75, na.rm = TRUE), digits = 0)
round(quantile(datos$adopcion_perspectivas, 0.80, na.rm = TRUE), digits = 0)
round(quantile(datos$adopcion_perspectivas, 0.85, na.rm = TRUE), digits = 0)
round(quantile(datos$adopcion_perspectivas, 0.90, na.rm = TRUE), digits = 0)
round(quantile(datos$adopcion_perspectivas, 0.95, na.rm = TRUE), digits = 0)
round(quantile(datos$adopcion_perspectivas, 0.99, na.rm = TRUE), digits = 0)
```

```{r}
round(quantile(datos$comprension_emocional, 0.01, na.rm = TRUE), digits = 0)
round(quantile(datos$comprension_emocional, 0.05, na.rm = TRUE), digits = 0)
round(quantile(datos$comprension_emocional, 0.1, na.rm = TRUE), digits = 0)
round(quantile(datos$comprension_emocional, 0.15, na.rm = TRUE), digits = 0)
round(quantile(datos$comprension_emocional, 0.2, na.rm = TRUE), digits = 0)
round(quantile(datos$comprension_emocional, 0.25, na.rm = TRUE), digits = 0)
round(quantile(datos$comprension_emocional, 0.3, na.rm = TRUE), digits = 0)
round(quantile(datos$comprension_emocional, 0.35, na.rm = TRUE), digits = 0)
round(quantile(datos$comprension_emocional, 0.40, na.rm = TRUE), digits = 0)
round(quantile(datos$comprension_emocional, 0.45, na.rm = TRUE), digits = 0)
round(quantile(datos$comprension_emocional, 0.50, na.rm = TRUE), digits = 0)
round(quantile(datos$comprension_emocional, 0.55, na.rm = TRUE), digits = 0)
round(quantile(datos$comprension_emocional, 0.60, na.rm = TRUE), digits = 0)
round(quantile(datos$comprension_emocional, 0.65, na.rm = TRUE), digits = 0)
round(quantile(datos$comprension_emocional, 0.70, na.rm = TRUE), digits = 0)
round(quantile(datos$comprension_emocional, 0.75, na.rm = TRUE), digits = 0)
round(quantile(datos$comprension_emocional, 0.80, na.rm = TRUE), digits = 0)
round(quantile(datos$comprension_emocional, 0.85, na.rm = TRUE), digits = 0)
round(quantile(datos$comprension_emocional, 0.90, na.rm = TRUE), digits = 0)
round(quantile(datos$comprension_emocional, 0.95, na.rm = TRUE), digits = 0)
round(quantile(datos$comprension_emocional, 0.99, na.rm = TRUE), digits = 0)
```

```{r}
round(quantile(datos$estres_empatico, 0.01, na.rm = TRUE), digits = 0)
round(quantile(datos$estres_empatico, 0.05, na.rm = TRUE), digits = 0)
round(quantile(datos$estres_empatico, 0.1, na.rm = TRUE), digits = 0)
round(quantile(datos$estres_empatico, 0.15, na.rm = TRUE), digits = 0)
round(quantile(datos$estres_empatico, 0.2, na.rm = TRUE), digits = 0)
round(quantile(datos$estres_empatico, 0.25, na.rm = TRUE), digits = 0)
round(quantile(datos$estres_empatico, 0.3, na.rm = TRUE), digits = 0)
round(quantile(datos$estres_empatico, 0.35, na.rm = TRUE), digits = 0)
round(quantile(datos$estres_empatico, 0.40, na.rm = TRUE), digits = 0)
round(quantile(datos$estres_empatico, 0.45, na.rm = TRUE), digits = 0)
round(quantile(datos$estres_empatico, 0.50, na.rm = TRUE), digits = 0)
round(quantile(datos$estres_empatico, 0.55, na.rm = TRUE), digits = 0)
round(quantile(datos$estres_empatico, 0.60, na.rm = TRUE), digits = 0)
round(quantile(datos$estres_empatico, 0.65, na.rm = TRUE), digits = 0)
round(quantile(datos$estres_empatico, 0.70, na.rm = TRUE), digits = 0)
round(quantile(datos$estres_empatico, 0.75, na.rm = TRUE), digits = 0)
round(quantile(datos$estres_empatico, 0.80, na.rm = TRUE), digits = 0)
round(quantile(datos$estres_empatico, 0.85, na.rm = TRUE), digits = 0)
round(quantile(datos$estres_empatico, 0.90, na.rm = TRUE), digits = 0)
round(quantile(datos$estres_empatico, 0.95, na.rm = TRUE), digits = 0)
round(quantile(datos$estres_empatico, 0.99, na.rm = TRUE), digits = 0)
```


```{r}
round(quantile(datos$alegria_empatica, 0.01, na.rm = TRUE), digits = 0)
round(quantile(datos$alegria_empatica, 0.05, na.rm = TRUE), digits = 0)
round(quantile(datos$alegria_empatica, 0.1, na.rm = TRUE), digits = 0)
round(quantile(datos$alegria_empatica, 0.15, na.rm = TRUE), digits = 0)
round(quantile(datos$alegria_empatica, 0.2, na.rm = TRUE), digits = 0)
round(quantile(datos$alegria_empatica, 0.25, na.rm = TRUE), digits = 0)
round(quantile(datos$alegria_empatica, 0.3, na.rm = TRUE), digits = 0)
round(quantile(datos$alegria_empatica, 0.35, na.rm = TRUE), digits = 0)
round(quantile(datos$alegria_empatica, 0.40, na.rm = TRUE), digits = 0)
round(quantile(datos$alegria_empatica, 0.45, na.rm = TRUE), digits = 0)
round(quantile(datos$alegria_empatica, 0.50, na.rm = TRUE), digits = 0)
round(quantile(datos$alegria_empatica, 0.55, na.rm = TRUE), digits = 0)
round(quantile(datos$alegria_empatica, 0.60, na.rm = TRUE), digits = 0)
round(quantile(datos$alegria_empatica, 0.65, na.rm = TRUE), digits = 0)
round(quantile(datos$alegria_empatica, 0.70, na.rm = TRUE), digits = 0)
round(quantile(datos$alegria_empatica, 0.75, na.rm = TRUE), digits = 0)
round(quantile(datos$alegria_empatica, 0.80, na.rm = TRUE), digits = 0)
round(quantile(datos$alegria_empatica, 0.85, na.rm = TRUE), digits = 0)
round(quantile(datos$alegria_empatica, 0.90, na.rm = TRUE), digits = 0)
round(quantile(datos$alegria_empatica, 0.95, na.rm = TRUE), digits = 0)
round(quantile(datos$alegria_empatica, 0.99, na.rm = TRUE), digits = 0)
```

```{r}
round(quantile(datos$score, 0.01, na.rm = TRUE), digits = 0)
round(quantile(datos$score, 0.05, na.rm = TRUE), digits = 0)
round(quantile(datos$score, 0.1, na.rm = TRUE), digits = 0)
round(quantile(datos$score, 0.15, na.rm = TRUE), digits = 0)
round(quantile(datos$score, 0.2, na.rm = TRUE), digits = 0)
round(quantile(datos$score, 0.25, na.rm = TRUE), digits = 0)
round(quantile(datos$score, 0.3, na.rm = TRUE), digits = 0)
round(quantile(datos$score, 0.35, na.rm = TRUE), digits = 0)
round(quantile(datos$score, 0.40, na.rm = TRUE), digits = 0)
round(quantile(datos$score, 0.45, na.rm = TRUE), digits = 0)
round(quantile(datos$score, 0.50, na.rm = TRUE), digits = 0)
round(quantile(datos$score, 0.55, na.rm = TRUE), digits = 0)
round(quantile(datos$score, 0.60, na.rm = TRUE), digits = 0)
round(quantile(datos$score, 0.65, na.rm = TRUE), digits = 0)
round(quantile(datos$score, 0.70, na.rm = TRUE), digits = 0)
round(quantile(datos$score, 0.75, na.rm = TRUE), digits = 0)
round(quantile(datos$score, 0.80, na.rm = TRUE), digits = 0)
round(quantile(datos$score, 0.85, na.rm = TRUE), digits = 0)
round(quantile(datos$score, 0.90, na.rm = TRUE), digits = 0)
round(quantile(datos$score, 0.95, na.rm = TRUE), digits = 0)
round(quantile(datos$score, 0.99, na.rm = TRUE), digits = 0)
```

```{r}
mean(datos$adopcion_perspectivas, na.rm = TRUE)
median(datos$adopcion_perspectivas, na.rm = TRUE)
sd(datos$adopcion_perspectivas, na.rm = TRUE)
min(datos$adopcion_perspectivas, na.rm = TRUE)
max(datos$adopcion_perspectivas, na.rm = TRUE)
```

```{r}
mean(datos$comprension_emocional, na.rm = TRUE)
median(datos$comprension_emocional, na.rm = TRUE)
sd(datos$comprension_emocional, na.rm = TRUE)
min(datos$comprension_emocional, na.rm = TRUE)
max(datos$comprension_emocional, na.rm = TRUE)
```


```{r}
mean(datos$estres_empatico, na.rm = TRUE)
median(datos$estres_empatico, na.rm = TRUE)
sd(datos$estres_empatico, na.rm = TRUE)
min(datos$estres_empatico, na.rm = TRUE)
max(datos$estres_empatico, na.rm = TRUE)
```


```{r}
mean(datos$alegria_empatica, na.rm = TRUE)
median(datos$alegria_empatica, na.rm = TRUE)
sd(datos$alegria_empatica, na.rm = TRUE)
min(datos$alegria_empatica, na.rm = TRUE)
max(datos$alegria_empatica, na.rm = TRUE)
```

```{r}
mean(datos$score, na.rm = TRUE)
median(datos$score, na.rm = TRUE)
sd(datos$score, na.rm = TRUE)
min(datos$score, na.rm = TRUE)
max(datos$score, na.rm = TRUE)
```


```{r}
x <- mean(datos$score, na.rm = TRUE)
y <- sd(datos$score, na.rm = TRUE)

a<-round(quantile(datos$score, 0.01, na.rm = TRUE), digits = 0)
b<-round(quantile(datos$score, 0.05, na.rm = TRUE), digits = 0)
c<-round(quantile(datos$score, 0.1, na.rm = TRUE), digits = 0)
d<-round(quantile(datos$score, 0.15, na.rm = TRUE), digits = 0)
e<-round(quantile(datos$score, 0.2, na.rm = TRUE), digits = 0)
f<-round(quantile(datos$score, 0.25, na.rm = TRUE), digits = 0)
g<-round(quantile(datos$score, 0.3, na.rm = TRUE), digits = 0)
h<-round(quantile(datos$score, 0.35, na.rm = TRUE), digits = 0)
i<-round(quantile(datos$score, 0.40, na.rm = TRUE), digits = 0)
j<-round(quantile(datos$score, 0.45, na.rm = TRUE), digits = 0)
k<-round(quantile(datos$score, 0.50, na.rm = TRUE), digits = 0)
l<-round(quantile(datos$score, 0.55, na.rm = TRUE), digits = 0)
m<-round(quantile(datos$score, 0.60, na.rm = TRUE), digits = 0)
n<-round(quantile(datos$score, 0.65, na.rm = TRUE), digits = 0)
o<-round(quantile(datos$score, 0.70, na.rm = TRUE), digits = 0)
p<-round(quantile(datos$score, 0.75, na.rm = TRUE), digits = 0)
q<-round(quantile(datos$score, 0.80, na.rm = TRUE), digits = 0)
r<-round(quantile(datos$score, 0.85, na.rm = TRUE), digits = 0)
s<-round(quantile(datos$score, 0.90, na.rm = TRUE), digits = 0)
t<-round(quantile(datos$score, 0.95, na.rm = TRUE), digits = 0)
u<-round(quantile(datos$score, 0.99, na.rm = TRUE), digits = 0)

data <- data.frame(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u)
transpose <- data.frame(t(data))

datos_T <- transpose %>%
  mutate(punt_T = round((((X1.-x)/y)*10) + 50, digits = 0))
