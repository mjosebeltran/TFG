...
Calculamos la matriz de correlacion "policorica"
...
Para cada ítem obtenemos múltiples parámetros de umbral (número de categorías -1). Por lo tanto, obtenemos cuatro parámetros de umbral para cada elemento que denotan los puntos de cambio para las categorías en el rasgo de depresión subyacente.
